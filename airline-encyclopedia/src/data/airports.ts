...
export const airports: Record<string, Airport> = {
  ...
  PKX: { code: "PKX", name: "Beijing Daxing International", city: "Beijing", country: "China", lat: 39.5092, lng: 116.4106 },
  HGH: { code: "HGH", name: "Hangzhou Xiaoshan International", city: "Hangzhou", country: "China", lat: 30.2294, lng: 120.4344 },
  TAO: { code: "TAO", name: "Qingdao Jiaodong International", city: "Qingdao", country: "China", lat: 36.3619, lng: 120.0883 },
  ...
  URC: { code: "URC", name: "Ürümqi Tianshan International", city: "Ürümqi", country: "China", lat: 43.9072, lng: 87.4742 },
  SVO: { code: "SVO", name: "Sheremetyevo International", city: "Moscow", country: "Russia", lat: 55.9726, lng: 37.4146 },
