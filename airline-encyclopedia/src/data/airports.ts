...
export const airports: Record<string, Airport> = {
  ...
  BEY: { code: "BEY", name: "Beirut–Rafic Hariri International", city: "Beirut", country: "Lebanon", lat: 33.8209, lng: 35.4884 },
  ...
  SAW: { code: "SAW", name: "Istanbul Sabiha Gökçen", city: "Istanbul", country: "Turkey", lat: 40.8986, lng: 29.3092 },
