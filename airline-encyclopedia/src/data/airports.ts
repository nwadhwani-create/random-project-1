...
export const airports: Record<string, Airport> = {
  ...
  CGP: { code: "CGP", name: "Shah Amanat International", city: "Chittagong", country: "Bangladesh", lat: 22.2496, lng: 91.8133 },
  CXB: { code: "CXB", name: "Cox's Bazar", city: "Cox's Bazar", country: "Bangladesh", lat: 21.4522, lng: 91.9639 },
  CAN: { code: "CAN", name: "Guangzhou Baiyun International", city: "Guangzhou", country: "China", lat: 23.3924, lng: 113.2988 },
  MCT: { code: "MCT", name: "Muscat International", city: "Muscat", country: "Oman", lat: 23.5933, lng: 58.2844 },
