...
export const airports: Record<string, Airport> = {
  ...
  NCE: { code: "NCE", name: "Nice Côte d'Azur", city: "Nice", country: "France", lat: 43.6584, lng: 7.2159 },
  OPO: { code: "OPO", name: "Francisco Sá Carneiro", city: "Porto", country: "Portugal", lat: 41.2481, lng: -8.6814 },
  ...
  KEF: { code: "KEF", name: "Keflavík International", city: "Reykjavik", country: "Iceland", lat: 63.9850, lng: -22.6056 },
  SPU: { code: "SPU", name: "Split Airport", city: "Split", country: "Croatia", lat: 43.5389, lng: 16.2980 },
  BRI: { code: "BRI", name: "Bari Karol Wojtyła", city: "Bari", country: "Italy", lat: 41.1389, lng: 16.7606 },
  SCQ: { code: "SCQ", name: "Santiago-Rosalía de Castro", city: "Santiago de Compostela", country: "Spain", lat: 42.8963, lng: -8.4151 },
  ...
  TLV: { code: "TLV", name: "Ben Gurion Airport", city: "Tel Aviv", country: "Israel", lat: 32.0114, lng: 34.8867 },
