...
export const airports: Record<string, Airport> = {
  ...
  RGN: { code: "RGN", name: "Yangon International", city: "Yangon", country: "Myanmar", lat: 16.9073, lng: 96.1331 },
  MDL: { code: "MDL", name: "Mandalay International", city: "Mandalay", country: "Myanmar", lat: 21.7022, lng: 95.9780 },
  NYT: { code: "NYT", name: "Nay Pyi Taw International", city: "Naypyidaw", country: "Myanmar", lat: 19.6235, lng: 96.2010 },
  NYU: { code: "NYU", name: "Nyaung U Airport", city: "Bagan", country: "Myanmar", lat: 21.1788, lng: 94.9301 },
  HEH: { code: "HEH", name: "Heho Airport", city: "Heho", country: "Myanmar", lat: 20.7470, lng: 96.7920 },
  SNW: { code: "SNW", name: "Thandwe Airport", city: "Thandwe", country: "Myanmar", lat: 18.4607, lng: 94.3001 },
  TVY: { code: "TVY", name: "Dawei Airport", city: "Dawei", country: "Myanmar", lat: 14.1039, lng: 98.2036 },
  KAW: { code: "KAW", name: "Kawthaung Airport", city: "Kawthaung", country: "Myanmar", lat: 10.0493, lng: 98.5380 },
  MYT: { code: "MYT", name: "Myitkyina Airport", city: "Myitkyina", country: "Myanmar", lat: 25.3836, lng: 97.3519 },
  AKY: { code: "AKY", name: "Sittwe Airport", city: "Sittwe", country: "Myanmar", lat: 20.1327, lng: 92.8726 },
  MGZ: { code: "MGZ", name: "Myeik Airport", city: "Myeik", country: "Myanmar", lat: 12.4398, lng: 98.6215 },
  THL: { code: "THL", name: "Tachileik Airport", city: "Tachileik", country: "Myanmar", lat: 20.4838, lng: 99.9354 },
