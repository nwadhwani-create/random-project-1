...
export const airports: Record<string, Airport> = {
  ...
  PKN: { code: "PKN", name: "Iskandar Airport", city: "Pangkalan Bun", country: "Indonesia", lat: -2.7052, lng: 111.6730 },
  SMQ: { code: "SMQ", name: "H. Asan Airport", city: "Sampit", country: "Indonesia", lat: -2.4992, lng: 112.9750 },
